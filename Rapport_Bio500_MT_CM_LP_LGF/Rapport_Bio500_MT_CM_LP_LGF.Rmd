...
Dans un contexte de changements environnementaux rapides, les structures des communautés d’insectes, dont les lépidoptères, subissent d’importantes transformations.Cette étude s’appuie sur des données, provenant en partie d’observation citoyennes, pour analyser la distribution spatiale des lépidoptères au Québec. Les variations du nombre d’observations sont examinées selon la latitude et la longitude, afin de détecter des tendances spatiales selon les zones climatiques.. 
